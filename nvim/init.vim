...
"guru needs to be installed manually with go install golang.org/x/tools/cmd/guru@latest
let g:go_install_tools_skip = ['guru']
...
" Optional: Use ALE for additional linting
let g:ale_linters = {
\   'go': ['golint', 'errcheck'],
\}
set autowrite
...
"highlighting can cause performance issues
